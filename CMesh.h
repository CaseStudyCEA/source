...
public:
	void draw(const D3DXMATRIXA16* matView,const D3DXMATRIXA16* matWorld);							///< 描画設定

private:
	void drawEffectOff(const D3DXMATRIXA16* matView,const D3DXMATRIXA16* matWorld);					///<	エフェクトなし描画
